...
given an email account with the same credentials as this site
when I redirect to my email account
then I should already be logged in to my email account
*/
...
public class JUnitStory3Case1 {
  ...
  @Test
  public void testJUnitStory3Case1() throws Exception {
